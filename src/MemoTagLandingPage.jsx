...
import { Sun, Moon, Brain, Activity, ChevronRight, Check, Users, Award, Database } from 'lucide-react';
...
export default function MemoTagLandingPage() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (problemSection) {
        setIsVisible(prev => ({
          ...prev,
          problem: window.scrollY > problemSection.offsetTop - window.innerHeight * 0.75
        }));
      }
      ...
      if (solutionSection) {
        setIsVisible(prev => ({
          ...prev,
          solution: window.scrollY > solutionSection.offsetTop - window.innerHeight * 0.75
        }));
      }
      ...
      if (tractionSection) {
        setIsVisible(prev => ({
          ...prev,
          traction: window.scrollY > tractionSection.offsetTop - window.innerHeight * 0.75
        }));
      }
    };
  ...
  return (
    <div className={`${darkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'} min-h-screen transition-colors duration-300`}>
      {/* Navigation */}
      <nav className="fixed w-full z-10 px-4 md:px-6 py-4 flex justify-between items-center backdrop-blur-md bg-opacity-80 shadow-sm" style={{ backgroundColor: darkMode ? 'rgba(17, 24, 39, 0.8)' : 'rgba(255, 255, 255, 0.8)' }}>
        ...
        <div className="flex items-center space-x-4">
          ...
          <a href="#contact" className="hidden md:block px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors">
            Get Started
          </a>
        </div>
      </nav>
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 px-4 md:px-6 flex flex-col items-center text-center">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">AI-Powered Dementia Care</h1>
          <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto text-gray-600 dark:text-gray-300">
            Empowering caregivers with personalized, intelligent tools to improve quality of life for dementia patients.
          </p>
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <a href="#contact" className="px-8 py-3 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors flex items-center justify-center">
              Get Early Access <ChevronRight className="ml-2 h-4 w-4" />
            </a>
            <a href="#solution" className="px-8 py-3 border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
              Learn More
            </a>
          </div>
        </motion.div>
        ...
        >
          <div className="w-full h-64 md:h-96 rounded-lg bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center">
            <div className="text-white text-center p-8">
              <h3 className="text-2xl font-semibold mb-4">Interactive MemoTag Interface</h3>
      ...
      {/* Problem Section */}
      <section id="problem" className="py-16 md:py-24 px-4 md:px-6 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">The Growing Challenge of Dementia Care</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Dementia affects millions, yet caregivers lack the tools to provide optimal support.
            </p>
          </motion.div>

          <motion.div 
            initial={{ opacity: 0, y: 50 }}
            animate={isVisible.problem ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }}
          ...
          >
            ...
            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Early symptoms often go undetected, leading to delayed interventions and treatment.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Caregivers struggle to track behavioral patterns and cognitive changes over time.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section id="solution" className="py-16 md:py-24 px-4 md:px-6">
        <div className="max-w-6xl mx-auto">
          <motion.div 
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">How MemoTag Works</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Our AI-powered platform combines physical tracking with cognitive assessment to provide comprehensive care.
            </p>
          </motion.div>

          <motion.div 
            initial={{ opacity: 0, y: 50 }}
            animate={isVisible.solution ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }}
                  ...
                  >
                    <div className="bg-indigo-50 dark:bg-indigo-900/30 p-6 md:p-8 rounded-lg">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 mb-4">
                        Discrete wearable sensors monitor movement, location, and vital signs to detect unusual patterns early.
                      </p>
                ...
                <div className="md:w-1/2 mb-6 md:mb-0 md:pl-12">
                  ...
                  >
                    <div className="bg-purple-50 dark:bg-purple-900/30 p-6 md:p-8 rounded-lg">
                      <h3 className="text-2xl font-semibold mb-4">AI Cognitive Assessment</h3>
                      <p className="text-gray-600 dark:text-gray-300 mb-4">
                        Regular, non-intrusive cognitive tests analyze memory, language, and problem-solving abilities.
                      </p>
                      <ul className="space-y-2">
                        <li className="flex items-center">
                          <Check className="h-5 w-5 text-green-500 mr-2" />
                ...
                <div className="md:w-1/2 mb-6 md:mb-0 md:pr-12">
                  ...
                  >
                    <div className="bg-pink-50 dark:bg-pink-900/30 p-6 md:p-8 rounded-lg">
                      <h3 className="text-2xl font-semibold mb-4">Caregiver Dashboard</h3>
                      <p className="text-gray-600 dark:text-gray-300 mb-4">
                        Intuitive interface providing actionable insights and personalized care recommendations.
                      </p>
                      <ul className="space-y-2">
                        <li className="flex items-center">
                          <Check className="h-5 w-5 text-green-500 mr-2" />
      ...
      {/* Traction Section */}
      <section id="traction" className="py-16 md:py-24 px-4 md:px-6 bg-indigo-50 dark:bg-indigo-900/20">
        <div className="max-w-6xl mx-auto">
          <motion.div 
            initial={{ opacity: 0 }}
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              MemoTag is quickly gaining traction with caregivers, medical professionals, and investors.
            </p>
          </motion.div>

          <motion.div 
            initial={{ opacity: 0, y: 50 }}
            animate={isVisible.traction ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }}
            transition={{ delay: 0.2, duration: 0.8 }}
            className="grid grid-cols-1 md:grid-cols-4 gap-6"
          >
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center">
              <h3 className="text-3xl font-bold text-indigo-600">2,500+</h3>
              <p className="text-gray-600 dark:text-gray-300 mt-2">Waitlist Signups</p>
            </div>

            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center">
              <h3 className="text-3xl font-bold text-indigo-600">12</h3>
              <p className="text-gray-600 dark:text-gray-300 mt-2">Care Facilities Piloting</p>
            </div>

            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center">
              <h3 className="text-3xl font-bold text-indigo-600">$1.8M</h3>
              <p className="text-gray-600 dark:text-gray-300 mt-2">Seed Funding Raised</p>
            </div>

            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center">
              <h3 className="text-3xl font-bold text-indigo-600">94%</h3>
              <p className="text-gray-600 dark:text-gray-300 mt-2">Caregiver Satisfaction</p>
            </div>
          </motion.div>
          ...
          >
            <h3 className="text-2xl font-semibold mb-6 text-center">What Caregivers Are Saying</h3>
            <div className="italic text-gray-600 dark:text-gray-300 text-center max-w-3xl mx-auto">
              "MemoTag has completely transformed how I care for my mother. The insights I get have helped us identify triggers for agitation and adjust her routine accordingly. It's given us both more peace of mind."
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
              Be among the first to access MemoTag and transform dementia care for your loved ones.
            </p>
                ...
                {!isSubscribed ? (
                  ...
                  >
                    ...
                    <div className="flex items-start">
                      ...
                      />
                      <label htmlFor="caregiver" className="ml-2 block text-sm text-gray-600 dark:text-gray-300 text-left">
